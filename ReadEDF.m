...
% Block structure:
% [(d seconds of 1 channel) (d seconds of 2 channel) ... (d seconds of Сh channel)], Where Сh - quantity of channels, d - duration of the block
% Ch = header.channels
% d = header.duration
